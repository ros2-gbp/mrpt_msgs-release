## mrpt_msgs (rolling) - 0.6.0-1

The packages in the `mrpt_msgs` repository were released into the `rolling` distro by running `/home/jlblanco/.local/bin/bloom-release -y -r rolling mrpt_msgs` on `Fri, 17 Oct 2025 08:50:19 -0000`
